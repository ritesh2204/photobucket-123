        ...
        <main className="ms-container">
          ...
          <div className="ms-section__block">
            <div className="ms-page-title">
              <h2 className="page-header">BLOG-4</h2>
            ...
            <div id="ms-blog-post" className="row">
              <div className="col-md-8">
                ...
                <blockquote>
                  ...
                  wizard, or even have a degree in design in order to be a
                  highly effective product designer.”
                </blockquote>
                <p>
                ...
                <p>
                  Phosfluorescently facilitate alternative e-commerce rather
                  than turnkey ideas. Collaboratively synergize superior best
                  practices with scalable e-business. Uniquely disseminate{" "}
                  <a href="#" title="link">
                    B2C
                  </a>{" "}
