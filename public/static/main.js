(function (window) {
  ...
  function PageTransition() {
    ...
    $(document).on("click", '[data-type="page-transition"]', function (e) {
      ...
      if (url != "#" && url != "") {
        ...
        if (pathname !== "/") {
          $(".hamburger").removeClass("navbar-white  .hamburger-label");
        }
  ...
  function Menu() {
    ...
    if (pathname === "/") {
      $(".hamburger").addClass("navbar-white  .hamburger-label");
      $(".ms-header")
    ...
    if ($.exists(".hamburger")) {
      $(".hamburger").on("click", function (e) {
        ...
        if (pathname !== "/") {
          $(burger).removeClass("navbar-white  .hamburger-label");
        }
        $(".ms-nav").toggleClass("is-visible");
        $(".ms-header")
          .toggleClass(".navbar-white")
          .each(function () {
            if (pathname !== "/") {
  ...
  function ValidForm() {
    if ($.exists("#validForm")) {
      var status = document.getElementById("my-status-form");
      ...
      $("#validForm").validate({
        ...
        submitHandler: function (form) {
          $.ajax({
            method: "POST",
            dataType: "json",
            url: "https://formspree.io/f/xpzkqgqw",
            data: $(form).serialize(),
            headers: {
